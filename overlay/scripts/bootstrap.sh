...
sed -i -e "s%{{ steamcache_ip }}%$HOST_IP%g" /etc/bind/steamcache/db.content_.steampowered.com
sed -i -e "s%{{ steamcache_ip }}%$HOST_IP%g" /etc/bind/steamcache/db.cs.steampowered.com
